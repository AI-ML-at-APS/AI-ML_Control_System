...
class BoTorchSampler(BaseSampler):
    ...
    Args:
        candidates_func:
            ...
            number of objectives is one, Quasi MC-based batch Expected Improvement (qNEI) is used.
            ...
            .. seealso::
                See :func:`optuna.integration.botorch.qnei_candidates_func` for an example.
        constraints_func:
